...
///////////////////////////////////////////////////////////////////////	
    ...
    name = $( "#name" ),
    age   = $( "#age" ),
    all        = $( [] ).add( id ).add( name ).add( age ),
    tips   = $( ".validateTips" );
	bValid = bValid && checkLength( name, "Your Id", 3, 60 );
    bValid = bValid && checkLength( address, "Your Name", 3, 50 );
    bValid = bValid && checkLength( city, "Your Age", 3, 40 );
